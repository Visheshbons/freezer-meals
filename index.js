...
const data = {
  ...
  menu: [
    {
      id: "template-meal-1",
      name: "Template Meal 1",
      description: "A delicious meal with all the essentials",
      price: 10.99,
      image: "https://placehold.co/420x260/png",
      type: "main",
      time: "Lunch",
    },
    {
      id: "template-meal-2",
      name: "Template Meal 2",
      description: "A tasty template that is made without cardboard",
      price: 12.99,
      image: "https://placehold.co/420x260/png",
      type: "main",
      time: "Dinner",
    ...
    {
      id: "template-meal-3",
      name: "Template Meal 3",
      description: "A tasty dessert that is made with love",
      price: 14.99,
      image: "https://placehold.co/420x260/png",
      type: "dessert",
      time: null,
    ...
    {
      id: "template-meal-4",
      name: "Template Meal 4",
      description: "A masterchef worthy dessert",
      price: 14.99,
      image: "https://placehold.co/420x260/png",
      type: "dessert",
      time: null,
    ...
    {
      id: "template-meal-6",
      name: "Template Meal 6",
      description: "A tasty pasta bake to feed 5",
      price: 29.99,
      image: "https://placehold.co/420x260/png",
      type: "bundle",
      time: "Dinner",
    ...
    {
      id: "template-meal-7",
      name: "Template Meal 7",
      description: "Some cardboard. Sufficient food for a week.",
      price: 1.99,
      image: "https://placehold.co/420x260/png",
      type: "bundle",
      time: "Lunch",
    ...
    {
      id: "template-meal-11",
      name: "Template Meal 11",
      description: "A creamy spinach dip",
      price: 14.99,
      image: "https://placehold.co/420x260/png",
      type: "side",
      time: "Dinner",
    ...
    {
      id: "template-meal-12",
      name: "Template Meal 12",
      description: "A delicious chicken salad",
      price: 16.99,
      image: "https://placehold.co/420x260/png",
      type: "side",
      time: "Lunch",
